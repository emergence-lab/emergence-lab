...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'investigation.slug'
        db.add_column(u'investigations', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from=u'name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'investigation.slug'
        db.delete_column(u'investigations', 'slug')
