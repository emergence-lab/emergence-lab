...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'name'))

    def backwards(self, orm):

        # Changing field 'project.slug'
        db.alter_column(u'projects', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=45))
