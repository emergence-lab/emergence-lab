...
urlpatterns = [
    ...
    url(r'^create/$', core.views.ProcessCreateView.as_view(),
        name='process_create'),
    url(r'^wizard/$', core.views.ProcessWizardView.as_view(),
        name='process_wizard'),
    ...
    url(r'^create/(?P<id>[0-9]+)$', core.views.ProcessCreateFromTemplateView.as_view(),
        name='process_create_from_template'),
    url(r'^create/(?P<uuid>p[0-9a-f\-]{7,})$',
        core.views.ProcessCreateFromTemplateView.as_view(),
        name='process_create_from_template'),
