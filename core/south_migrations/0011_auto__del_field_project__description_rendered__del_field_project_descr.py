...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects', 'description', self.gf('ckeditor.fields.RichTextField')())
        ...
        # Changing field 'investigation.description'
        db.alter_column(u'investigations', 'description', self.gf('ckeditor.fields.RichTextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'investigation.description'
        db.alter_column(u'investigations', 'description', self.gf('markupfield.fields.MarkupField')(rendered_field=True))
