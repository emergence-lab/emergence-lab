...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'project_tracking'
        db.create_table(u'project_operator_tracking', (
            ...
            ('is_pi', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'core', ['project_tracking'])


    def backwards(self, orm):
        # Deleting model 'project_tracking'
        db.delete_table(u'project_operator_tracking')
