...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'afm.filename'
        db.alter_column('afm', 'filename', self.gf('django.db.models.fields.files.ImageField')(max_length=150))

        # Changing field 'afm.amplitude_filename'
        db.alter_column('afm', 'amplitude_filename', self.gf('django.db.models.fields.files.ImageField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'afm.filename'
        db.alter_column('afm', 'filename', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'afm.amplitude_filename'
        db.alter_column('afm', 'amplitude_filename', self.gf('django.db.models.fields.CharField')(max_length=150))

    models = {
        u'afm.afm': {
            'Meta': {'object_name': 'afm', 'db_table': "'afm'"},
            'amplitude_filename': ('django.db.models.fields.files.ImageField', [], {'max_length': '150', 'blank': 'True'}),
            'filename': ('django.db.models.fields.files.ImageField', [], {'max_length': '150', 'blank': 'True'}),
