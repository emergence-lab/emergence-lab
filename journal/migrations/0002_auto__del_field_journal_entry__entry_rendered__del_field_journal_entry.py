...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'journal_entry._entry_rendered'
        db.delete_column(u'journal_entries', '_entry_rendered')

        # Deleting field 'journal_entry.entry_markup_type'
        db.delete_column(u'journal_entries', 'entry_markup_type')


        # Changing field 'journal_entry.entry'
        db.alter_column(u'journal_entries', 'entry', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Adding field 'journal_entry._entry_rendered'
        db.add_column(u'journal_entries', '_entry_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'journal_entry.entry_markup_type'
        db.add_column(u'journal_entries', 'entry_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


        # Changing field 'journal_entry.entry'
        db.alter_column(u'journal_entries', 'entry', self.gf('markupfield.fields.MarkupField')(rendered_field=True))
