...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'hall.sheet_resistance'
        db.alter_column(u'hall', 'sheet_resistance', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'hall.bulk_concentration'
        db.alter_column(u'hall', 'bulk_concentration', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'hall.sheet_coefficient'
        db.alter_column(u'hall', 'sheet_coefficient', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'hall.mobility'
        db.alter_column(u'hall', 'mobility', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'hall.bulk_coefficient'
        db.alter_column(u'hall', 'bulk_coefficient', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'hall.bulk_resistance'
        db.alter_column(u'hall', 'bulk_resistance', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'hall.sheet_concentration'
        db.alter_column(u'hall', 'sheet_concentration', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'hall.sheet_resistance'
        db.alter_column(u'hall', 'sheet_resistance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'hall.bulk_concentration'
        db.alter_column(u'hall', 'bulk_concentration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'hall.sheet_coefficient'
        db.alter_column(u'hall', 'sheet_coefficient', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'hall.mobility'
        db.alter_column(u'hall', 'mobility', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'hall.bulk_coefficient'
        db.alter_column(u'hall', 'bulk_coefficient', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'hall.bulk_resistance'
        db.alter_column(u'hall', 'bulk_resistance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'hall.sheet_concentration'
        db.alter_column(u'hall', 'sheet_concentration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        u'hall.hall': {
            ...
            'bulk_coefficient': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'bulk_concentration': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'bulk_resistance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'growth': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['growths.growth']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mobility': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'sample': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['growths.sample']"}),
            'sheet_coefficient': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'sheet_concentration': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'sheet_resistance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
