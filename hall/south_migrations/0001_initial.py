...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hall', (
            ...
            ('temperature', self.gf('django.db.models.fields.DecimalField')(default=300.0, max_digits=7, decimal_places=2, blank=True)),
            ('symmetry_factor', self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=7, decimal_places=2, blank=True)),
            ('sheet_coefficient', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('sheet_resistance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('sheet_concentration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('thickness', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('mobility', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('bulk_coefficient', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('bulk_resistance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('bulk_concentration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'hall', ['hall'])


    def backwards(self, orm):
        # Deleting model 'hall'
        db.delete_table(u'hall')
