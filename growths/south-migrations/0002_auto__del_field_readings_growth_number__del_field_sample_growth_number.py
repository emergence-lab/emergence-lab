...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'readings.growth_number'
        db.delete_column('readings', 'growth_number')

        # Deleting field 'sample.growth_number'
        db.delete_column('samples', 'growth_number')


    def backwards(self, orm):
        # Adding field 'readings.growth_number'
        db.add_column('readings', 'growth_number',
                      self.gf('django.db.models.fields.CharField')(default='g0000', max_length=10),
                      keep_default=False)

        # Adding field 'sample.growth_number'
        db.add_column('samples', 'growth_number',
                      self.gf('django.db.models.fields.CharField')(default='g0000', max_length=10),
                      keep_default=False)
