...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'sample.parent'
        db.alter_column('samples', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['growths.sample'], null=True))

    def backwards(self, orm):

        # Changing field 'sample.parent'
        db.alter_column('samples', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['growths.sample']))
