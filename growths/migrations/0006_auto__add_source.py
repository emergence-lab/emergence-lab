...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sources', (
            ...
            ('cp2mg', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('tmin1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('tmin2', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('tmga1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('tmga2', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('tmal1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('tega1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('nh3', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('sih4', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'growths', ['source'])
