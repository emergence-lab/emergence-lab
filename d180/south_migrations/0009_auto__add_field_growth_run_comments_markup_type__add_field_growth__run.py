...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'growth.run_comments_markup_type'
        db.add_column('growths', 'run_comments_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'growth._run_comments_rendered'
        db.add_column('growths', '_run_comments_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'growth.run_comments'
        db.alter_column('growths', 'run_comments', self.gf('markupfield.fields.MarkupField')(rendered_field=True))
        # Adding field 'sample.comment_markup_type'
        db.add_column('samples', 'comment_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'sample._comment_rendered'
        db.add_column('samples', '_comment_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'sample.comment'
        db.alter_column('samples', 'comment', self.gf('markupfield.fields.MarkupField')(rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'growth.run_comments_markup_type'
        db.delete_column('growths', 'run_comments_markup_type')

        # Deleting field 'growth._run_comments_rendered'
        db.delete_column('growths', '_run_comments_rendered')


        # Changing field 'growth.run_comments'
        db.alter_column('growths', 'run_comments', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'sample.comment_markup_type'
        db.delete_column('samples', 'comment_markup_type')

        # Deleting field 'sample._comment_rendered'
        db.delete_column('samples', '_comment_rendered')


        # Changing field 'sample.comment'
        db.alter_column('samples', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'growths.growth': {
            ...
            '_run_comments_rendered': ('django.db.models.fields.TextField', [], {}),
            ...
            'run_comments': ('markupfield.fields.MarkupField', [], {'rendered_field': 'True', 'blank': 'True'}),
            'run_comments_markup_type': ('django.db.models.fields.CharField', [], {'default': "'markdown'", 'max_length': '30', 'blank': 'True'})
        },
        u'growths.readings': {
        ...
        u'growths.sample': {
            ...
            '_comment_rendered': ('django.db.models.fields.TextField', [], {}),
            'comment': ('markupfield.fields.MarkupField', [], {'rendered_field': 'True', 'blank': 'True'}),
            'comment_markup_type': ('django.db.models.fields.CharField', [], {'default': "'markdown'", 'max_length': '30', 'blank': 'True'}),
            'growth': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['growths.growth']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
